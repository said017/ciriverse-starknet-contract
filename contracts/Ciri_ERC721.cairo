...
// index counter
@storage_var
func index_counter() -> (number: Uint256) {
}
...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let index_cnt : Uint256 = felt_to_uint256(0);
    index_counter.write(index_cnt);    
    // ERC721_Metadata_setTokenURI(base_token_uri_len, base_token_uri);
    return ();
}
...
func mint{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    to: felt, base_token_uri_len: felt, base_token_uri: felt*
) -> (token_id: Uint256)  {
    alloc_locals;
    Ownable.assert_only_owner();
    let _index_counter: Uint256 = index_counter.read();
    let index_counter_new : Uint256 = SafeUint256.add(_index_counter, Uint256(1, 0));

    ERC721._mint(to, index_counter_new);

    _setTokenURI(index_counter_new, base_token_uri_len, base_token_uri);

    index_counter.write(index_counter_new);
    return (token_id=index_counter_new);
}
